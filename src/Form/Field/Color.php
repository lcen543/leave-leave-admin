...
class Color extends Text
{
    protected static $css = [
        '/vendor/leave-admin/AdminLTE/plugins/colorpicker/bootstrap-colorpicker.min.css',
    ];

    protected static $js = [
        '/vendor/leave-admin/AdminLTE/plugins/colorpicker/bootstrap-colorpicker.min.js',
    ];
