...
class UninstallCommand extends Command
{
    ...
    {
        if (!$this->confirm('Are you sure to uninstall leave-admin?')) {
            return;
        }

        $this->removeFilesAndDirectories();

        $this->line('<info>Uninstalling leave-admin!</info>');
    }
    ...
    protected function removeFilesAndDirectories()
    {
        ...
        $this->laravel['files']->deleteDirectory(public_path('vendor/leave-admin/'));
