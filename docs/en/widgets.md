...
`Leave\Admin\Widgets\Box` used to generate box components:

```php
use Leave\Admin\Widgets\Box;
...
`Leave\Admin\Widgets\Collapse` class used to generate folding components:
```php
use Leave\Admin\Widgets\Collapse;
...
`Leave\Admin\Widgets\Form` class is used to quickly build a form:
...
`Leave\Admin\Widgets\InfoBox` class is used to generate the information presentation block:

```php
use Leave\Admin\Widgets\InfoBox;
...
Refer to the section on the `InfoBox` in the `index()` method of the home page layout file [HomeController.php](https://github.com/z-song/leave-admin/blob/master/src/Console/stubs/HomeController.stub).

## Tab component

`Leave\Admin\Widgets\Tab` class is used to generate the tab components:

```php
use Leave\Admin\Widgets\Tab;
...
`Leave\Admin\Widgets\Table` class is used to generate tables:

```php
use Leave\Admin\Widgets\Table;
